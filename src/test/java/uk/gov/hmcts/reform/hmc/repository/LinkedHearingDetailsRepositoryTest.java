...
class LinkedHearingDetailsRepositoryTest {
    ...
    void testGetLinkedHearingDetails() {
        ...
        Long groupId = 256L;
        Long order = 5L;
        LinkedHearingDetails lhdExpected =
    ...
    private LinkedHearingDetails generateLinkedHearingDetails(Long lhdId, Long lgdId, Long hearingId,
                                                              Long linkedOrder) {
        ...
        linkedHearingDetails.setLinkedHearingId(lhdId);
