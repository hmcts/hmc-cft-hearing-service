...
class FutureHearingErrorDecoderTest {
    ...
    private String inputString = "Response from FH failed with error code ";
    ...
    void shouldThrowBadFutureHearingRequestExceptionWith400Error() {
        ...
        assertEquals(Level.ERROR, logsList.get(0)
            .getLevel());
        assertEquals(inputString + "400", logsList.get(0)
            .getMessage());
    }
    ...
    void shouldThrowBadFutureHearingRequestExceptionWith401Error() {
        ...
        assertEquals(Level.ERROR, logsList.get(0)
            .getLevel());
        assertEquals(inputString + "401", logsList.get(0)
            .getMessage());
    }
    ...
    void shouldThrowAuthenticationExceptionWith500Error() {
        ...
        assertEquals(Level.ERROR, logsList.get(0)
            .getLevel());
        assertEquals(inputString + "500", logsList.get(0)
            .getMessage());
    }
}
