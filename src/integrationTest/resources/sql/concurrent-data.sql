-- Hearings not in a linked group
INSERT INTO hearing
(hearing_id, status, linked_group_id, linked_order, is_linked_flag,
 ...
 last_good_status)
VALUES
(2600000000, 'HEARING_REQUESTED', null, null, true,
...
(hearing_id, status, linked_group_id, linked_order, is_linked_flag,
 ...
 last_good_status)
VALUES
(2600000001, 'HEARING_REQUESTED', null, null, true,
...
(1, false, 'Some hearing type', 5, 'Standard',
 ...
 current_date, 1, 2600000000, false, '',
...
(hearing_id, status, linked_group_id, linked_order, is_linked_flag,
 ...
 last_good_status)
VALUES
(2600000002, 'HEARING_REQUESTED', 100000, 1, true,
 null, null, '2025-10-02 12:00:00', '2025-10-02 12:30:00', null,
 null);
...
(hearing_id, status, linked_group_id, linked_order, is_linked_flag,
 ...
 last_good_status)
VALUES
(2600000003, 'HEARING_REQUESTED', 100000, 2, true,
 null, null, '2025-10-02 13:00:00', '2025-10-02 13:30:00', null,
 null);
...
(case_hearing_id, auto_list_flag, hearing_type, required_duration_in_minutes, hearing_priority_type,
 ...
 is_a_panel_flag)
VALUES
(3, false, 'Some hearing type', 5, 'Standard',
 0, false, false, '', null,
 'ABA1', '2222333344445555', now(), 'EXT/REF234', 'https://www.google.com',
 'Internal case name', 'Public case name', false, 'CMLC123', false,
 current_date, 1, 2600000002, false, '',
 null, null, 'Some listing comments', '2025-10-02 12:00:00', 'user-added-comments',
 null);
...
(case_hearing_id, auto_list_flag, hearing_type, required_duration_in_minutes, hearing_priority_type,
 ...
 is_a_panel_flag)
VALUES
(4, false, 'Some hearing type', 5, 'Standard',
 0, false, false, '', null,
 'ABA1', '2222333344445555', now(), 'EXT/REF234', 'https://www.google.com',
 'Internal case name', 'Public case name', false, 'CMLC123', false,
 current_date, 1, 2600000003, false, '',
 null, null, 'Some listing comments', '2025-10-02 13:00:00', 'user-added-comments',
 null);
