...
insert into hearing_response(hearing_response_id, hearing_id, received_date_time, listing_status, listing_case_status, response_version, request_version, cancellation_reason_type)
values (1, '2000000000', '2020-08-10 11:20:00', 'listingStatus1-1', 'caselistingStatus1-1', '2', '1', 'cancelled because r1');
insert into hearing_response(hearing_response_id, hearing_id, received_date_time, listing_status, listing_case_status, response_version, request_version, cancellation_reason_type, parties_notified_datetime)
values (2, '2000000010', '2021-08-10 11:20:00', 'listingStatus1-1', 'caselistingStatus1-1', '2', '1', 'cancelled because r2', '2020-08-10 11:20:00');
insert into hearing_response(hearing_response_id, hearing_id, received_date_time, listing_status, listing_case_status, response_version, request_version, cancellation_reason_type)
values (3, '2000000009', '2021-08-10 11:20:00', 'listingStatus3-1', 'caselistingStatus3-1', '2', '1', 'cancelled because r3');
insert into hearing_response(hearing_response_id, hearing_id, received_date_time, listing_status, listing_case_status, response_version, request_version, cancellation_reason_type)
values (4, '2000000012', '2021-08-10 11:20:00', 'listingStatus3-1', 'caselistingStatus3-1', '1', '1', 'cancelled because r4');
insert into hearing_response(hearing_response_id, hearing_id, received_date_time, listing_status, listing_case_status, response_version, request_version, cancellation_reason_type)
values (5, '2000000013', '2021-08-10 11:20:00', 'listingStatus3-1', 'caselistingStatus3-1', '1', '1', 'cancelled because r5');
