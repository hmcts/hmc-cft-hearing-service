...
ALTER TABLE ONLY public.required_locations ADD COLUMN updated_date_time timestamp without time zone;
...
ALTER TABLE ONLY public.party_relationship_details ADD COLUMN updated_date_time timestamp without time zone;
...
ALTER TABLE ONLY public.hearing_response ADD COLUMN updated_date_time timestamp without time zone;
