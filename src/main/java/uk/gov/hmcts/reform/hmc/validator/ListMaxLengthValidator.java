...
public class ListMaxLengthValidator implements ConstraintValidator<ListMaxLength, List<String>> {
    ...
    public boolean isValid(List<String> reasonTypes, ConstraintValidatorContext context) {
        if (listName.equals(NON_STANDARD_HEARING_DURATION_REASONS)) {
            ...
            for (String reasonType : reasonTypes) {
                if (reasonType.length() > ROLE_TYPE_MAX_LENGTH) {
            ...
            for (String reasonType : reasonTypes) {
                if (reasonType.length() > AUTHORISATION_TYPE_MAX_LENGTH) {
            ...
            for (String reasonType : reasonTypes) {
                if (reasonType.length() > AUTHORISATION_SUB_TYPE_MAX_LENGTH) {
            ...
            for (String reasonType : reasonTypes) {
                if (reasonType.length() > PANEL_SPECIALISMS_MAX_LENGTH) {
            ...
            for (String reasonType : reasonTypes) {
                if (reasonType.length() > FACILITIES_REQUIRED_MAX_LENGTH) {
