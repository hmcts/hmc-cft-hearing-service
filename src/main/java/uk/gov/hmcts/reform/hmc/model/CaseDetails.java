...
public class CaseDetails {
    ...
    @Pattern(regexp = "^[\\p{L}\\p{N}\\p{P}\\p{Zs}]*$", message = ValidationError.INVALID_HMCTS_INTERNAL_CASE_NAME)
    ...
    @Pattern(regexp = "^[\\p{L}\\p{N}\\p{P}\\p{Zs}]*$", message = ValidationError.INVALID_PUBLIC_CASE_NAME)
