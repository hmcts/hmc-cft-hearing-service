...
public class HearingManagementServiceImpl implements HearingManagementService {
    ...
    public void validateHearingRequest(CreateHearingRequest createHearingRequest) {
    ...
    protected void validateHearingRequestDetails(CreateHearingRequest createHearingRequest) {
    ...
    /**
     * validate Hearing Window. Hearing Window cannot be null
     *
