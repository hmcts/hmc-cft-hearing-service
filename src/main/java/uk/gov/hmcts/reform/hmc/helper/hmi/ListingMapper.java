...
public class ListingMapper {
    ...
    public Listing getListing(HearingDetails hearingDetails, List<String> preferredHearingChannels) {
        ...
        Listing listing = Listing.builder()
            ...
            .listingDate(hearingDetails.getHearingWindow().getHearingWindowFirstDate().getFirstDateTimeMustBe())
            ...
            .build();
        if (hearingDetails.getHearingWindow().getHearingWindowDateRange().getHearingWindowStartDateRange() != null) {
            listing.setListingStartDate(hearingDetails.getHearingWindow().getHearingWindowDateRange()
                    .getHearingWindowStartDateRange());
        }
        if (hearingDetails.getHearingWindow().getHearingWindowDateRange().getHearingWindowEndDateRange() != null) {
            listing.setListingEndDate(hearingDetails.getHearingWindow().getHearingWindowDateRange()
